...
<p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-300 font-light leading-relaxed drop-shadow-md font-sans">
  A divine explosion of <span className="font-semibold text-white">color</span>, <span className="font-semibold text-white">culture</span>, and <span className="font-semibold text-white">devotion</span> — captured in its purest form from the sacred lands of <span className="text-white font-semibold">Mathura</span> and <span className="text-white font-semibold">Vrindavan</span>, where legends dance with every drop of color.
</p>
